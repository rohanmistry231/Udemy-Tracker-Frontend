...
const EditCourse = () => {
  ...
  const handleSkillsChange = (e) => {
    setCourse({ ...course, subLearningSkillsSet: e.target.value.split(',').map((skill) => skill.trim()) });
  };
    ...
    <div className={`container mx-auto px-4 py-6 mt-12 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
      <div className={`shadow-md rounded-lg p-6 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="mb-4">
            <label htmlFor="no" className="block mb-2">Course No:</label>
            <input
              type="number"
              id="no"
              name="no"
          ...
          <div className="mb-4">
            ...
            >
              ...
              {course.category && subCategories[course.category]?.map((sub) => (
                <option key={sub} value={sub}>{sub}</option>
              ))}
            </select>
          </div>
          <div className="mb-4">
            <label htmlFor="subSubCategory" className="block mb-2">Sub-Sub Category:</label>
            <input
              type="text"
              id="subSubCategory"
              name="subSubCategory"
          ...
          <div className="mb-4">
            <label htmlFor="categoryPriority" className="block mb-2">Category Priority:</label>
            <select
              id="categoryPriority"
          ...
          <div className="mb-4">
            <label htmlFor="importantStatus" className="block mb-2">Important Status:</label>
            <select
              id="importantStatus"
          ...
          <div className="mb-4">
            <label htmlFor="durationInHours" className="block mb-2">Duration in Hours:</label>
            <input
              type="number"
              id="durationInHours"
          ...
          <div className="mb-4">
            <label htmlFor="subLearningSkillsSet" className="block mb-2">Sub Learning Skills Set (comma-separated):</label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="learningSkillsSet" className="block mb-2">Learning Skills Set:</label>
            <input
              type="text"
